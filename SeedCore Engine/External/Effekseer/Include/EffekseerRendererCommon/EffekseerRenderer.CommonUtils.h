...
#include <External/Effekseer/Include/Effekseer/Material/Effekseer.CompiledMaterial.h>
#include <External/Effekseer/Include/Effekseer/Model/Effekseer.SplineGenerator.h>
#include <algorithm>
#include <array>
#include <assert.h>
#include <functional>
