...
FT_BEGIN_HEADER
   ...
   *   own projects.
   *
   * - Copy the file <External/MTSDF/Include/freetype/ft2build.h> to `$BUILD/ft2build.h` and modify it
   *   slightly to pre-define the macro `FT_CONFIG_OPTIONS_H` used to locate
   *   this file during the build.  For example,
   *
   *   ```
   *     #define FT_CONFIG_OPTIONS_H  <myftoptions.h>
   *     #include <External/MTSDF/Include/freetype/freetype/config/ftheader.h>
   *   ```
   *
   ...
   *   default, this file is `<External/MTSDF/Include/freetype/freetype/config/ftmodule.h>`.
   *
